  ...
  >
    ...
    <a-row align="center">
      ...
      >
        ...
        <span>{{ formatDateTime(props.Reply.created_at) }}</span>
    ...
    <a-row justify="start" class="ps-2 mt-2">
      <a-col :offset="1" :span="23" class="ps-2" v-html="props.Reply.content" />
    </a-row>
    <!-- #endregion -->
    <!-- #region 父级评论 -->
    <a-row v-if="hasParent">
      <a-col :offset="1" :span="23" class="ps-3">
        <div class="reply-text">&nbsp;&nbsp; “<span v-html="props.Reply.pContent" />”</div>
      </a-col>
    </a-row>
    <!-- #endregion -->
    <!-- #region 交互按钮 -->
